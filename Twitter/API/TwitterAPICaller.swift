...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "srhbpTVhuYTQbDMVn59y8LIYn", consumerSecret: "Zo0EeBvirqLUgbOHvgwlDw8ntPE2Q7ibstteMqWRBfzBQl73nM")
    var loginSuccess: (() -> ())?
    ...
    func retweetTweet(tweetId: String, success: @escaping () -> (), failure: @escaping (Error) -> ()) {
    ...
    func unretweetTweet(tweetId: String, success: @escaping () -> (), failure: @escaping (Error) -> ()) {
